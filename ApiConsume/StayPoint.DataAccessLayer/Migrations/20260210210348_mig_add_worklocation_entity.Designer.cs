...
namespace StayPoint.DataAccessLayer.Migrations
{
    ...
    [Migration("20260210210348_mig_add_worklocation_entity")]
    partial class mig_add_worklocation_entity
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("StayPoint.EntityLayer.Concrete.About", b =>
                {
            ...
            modelBuilder.Entity("StayPoint.EntityLayer.Concrete.AppRole", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("StayPoint.EntityLayer.Concrete.AppUser", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("StayPoint.EntityLayer.Concrete.Booking", b =>
                {
            ...
            modelBuilder.Entity("StayPoint.EntityLayer.Concrete.Contact", b =>
                {
            ...
            modelBuilder.Entity("StayPoint.EntityLayer.Concrete.Guest", b =>
                {
            ...
            modelBuilder.Entity("StayPoint.EntityLayer.Concrete.MessageCategory", b =>
                {
                    b.Property<int>("MessageCategoryID")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("StayPoint.EntityLayer.Concrete.SendMessage", b =>
                {
            ...
            modelBuilder.Entity("StayPoint.EntityLayer.Concrete.WorkLocation", b =>
                {
                    b.Property<int>("WorkLocationID")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityRoleClaim<int>", b =>
                {
                    b.HasOne("StayPoint.EntityLayer.Concrete.AppRole", null)
                        .WithMany()
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<int>", b =>
                {
                    b.HasOne("StayPoint.EntityLayer.Concrete.AppUser", null)
                        .WithMany()
            ...
            modelBuilder.Entity("StayPoint.EntityLayer.Concrete.AppUser", b =>
                {
                    b.HasOne("StayPoint.EntityLayer.Concrete.WorkLocation", "WorkLocation")
                        .WithMany("AppUsers")
            ...
            modelBuilder.Entity("StayPoint.EntityLayer.Concrete.Contact", b =>
                {
                    b.HasOne("StayPoint.EntityLayer.Concrete.MessageCategory", "MessageCategory")
                        .WithMany("Contacts")
